...
window.onload = function() {
    if (is.ie()) {
        ...
        e.className = "vacancies-closed", e.innerHTML = "Vagas encerradas!", document.getElementById("alert").appendChild(e)
    } else console.log("%cWooza", "color: #c4d82d; font-size: 24px;"), console.log("Primeira dica:"), console.log("TyBpbXBvcnRhbnRlIMOpIHRlciBlc3RpbG8uIE91IG7Do28gdGVyLCBlbSBhbGd1bnMgY2Fzb3MgOyk=")
};
let index = 1;
const input = document.getElementById("msg"),
     messages = ["RXN0YW1vcyByZWFsbWVudGUgbXVpdG8gZmVsaXplcw==", "cXVlIHZvY+ogdGVuaGEgY2hlZ2FkbyBhdOkgYXF1aSE=", "QWdvcmEgc/MgZmFsdGEgbyD6bHRpbW8gcGFzc286", "aHR0cHM6Ly9naXRodWIuY29tL3dvb3phYnIvdGVzdGUtZnJvbnQ="];
    // messages = ["TyBpbXBvcnRhbnRlIMOpIHRlciBlc3RpbG8uIE91IG7Do28gdGVyLCBlbSBhbGd1bnMgY2Fzb3MgOyk="]
input.value = atob(messages[0]), setInterval(() => {
    input.value = atob(messages[index]), index < messages.length - 1 ? index++ : index = 0
}, 10);

//1 menssagem* ESTAMOS REALMENTE MUITO FELIZES "RXN0YW1vcyByZWFsbWVudGUgbXVpdG8gZmVsaXplcw==" 
//2 menssagem QUE VOCÊ TENHA CHEGADO ATÉ AQUI! "cXVlIHZvY+ogdGVuaGEgY2hlZ2FkbyBhdOkgYXF1aSE="*/
//3 menssagem "AGORA SÓ FALTA O ÚLTIMO PASSO: "QWdvcmEgc/MgZmFsdGEgbyD6bHRpbW8gcGFzc286"/*
//4 menssagem "HTTPS://GITHUB.COM/WOOZABR/TESTE-FRONT"aHR0cHM6Ly9naXRodWIuY29tL3dvb3phYnIvdGVzdGUtZnJvbnQ="
